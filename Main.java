...
public class Main{
	public static void main(String args[]) throws IOException{
		...
		double endTime = 600;//シミュレーション時間(招集しないなら406秒
		...
		int x_FieldValue = rnd1.nextInt(2) + 22;
		int y_FieldValue = rnd1.nextInt(8) + 16;
		...
		for(int k = 0; k < peaple; k ++) {
	    	  iValue[k] = rnd2.nextInt(12) + 24;
	    	  jValue[k] = rnd2.nextInt(12) + 24;
	    	  boolean flag = false;
